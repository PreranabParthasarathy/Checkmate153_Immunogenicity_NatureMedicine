...
FeatureRank<-read.delim("/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/projects/BMS153/data/feature_rank_A0201_tt.txt",header = TRUE,sep="\t")
...
AAindexFull<-read.delim("/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/projects/BMS153/data/AAIndex.txt", sep="\t", header=T, row.names = 1)
tetposneg<-read.delim("/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/projects/BMS153/data/label_A0201_tt.txt", sep="\t", header=F)
...
aaindex_file<-"/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/Input/AutoFilt/MachineLearning_v2/data/TTN/all/output/AAINDEX.txt"
...
# ggplot(ss_master, aes(x=tetramer,y=SeqPos.4.JOND920102, fill=tetramer)) + geom_boxplot() + stat_compare_means() +theme_pubr()
# ggplot(ss_master, aes(x=tetramer_ml,y=SeqPos.4.JOND920102, fill=tetramer_ml)) + geom_boxplot() + stat_compare_means()+theme_pubr()
...
# ggplot(s_master_a0201, aes(x=tetramer,y=SeqPos.4.JOND920102, fill=tetramer)) + geom_boxplot() + stat_compare_means(comparisons = my_comparisons)+theme_pubr()
...
# ggplot(s_master_a0201, aes(x=tetramer_20cell,y=SeqPos.4.JOND920102, fill=tetramer_20cell)) + geom_boxplot() + stat_compare_means(comparisons = my_comparisons)+theme_pubr()
...
s_master_a0201<-s_master_a0201[which(s_master_a0201$Pep_Length == 9),]
# ggplot(s_master_a0201, aes(x=tetramer,y=MT.Score, fill=tetramer)) + geom_boxplot() + stat_compare_means(comparisons = my_comparisons)+theme_pubr()
...
#dev.off()
# ggplot(s_master_a0201, aes(x=tetramer_20cell,y=MT.Score, fill=tetramer_20cell)) + geom_boxplot() + stat_compare_means(comparisons = my_comparisons)+theme_pubr()
...
out_dir<-"/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/projects/BMS153/data/plots/SupplementalFigure8/May/"

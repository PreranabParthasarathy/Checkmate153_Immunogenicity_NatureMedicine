...
out_dir<-"/Volumes/chant2lab/ChanLab_Common_Drive/Prerana/projects/BMS153/data/plots/Figure4/"
```
...
```{r DEF2, echo=FALSE}
# d<-ggplot(s_master_ndt_tet, aes(x=tetramer,y=DeltaCCF, fill = tetramer)) + geom_boxplot() +stat_compare_means(method = "t.test") + theme_pubclean() + scale_fill_manual(values = c("green2","blue2"))
# 
# e<-ggplot(s_master_ndt_tet, aes(x=tetramer,y=DeltaCCF,fill=tetramer)) + geom_boxplot() + facet_wrap(~pre_clonal)+stat_compare_means(method = "t.test") + theme_pubclean()+ scale_fill_manual(values = c("green2","blue2"))
# 
# f<-ggplot(s_master_ndt_tet, aes(x=tetramer,y=DeltaCCF,fill=tetramer)) + geom_boxplot() + facet_wrap(~response)+stat_compare_means(method = "t.test") + theme_pubclean()+ scale_fill_manual(values = c("green2","blue2"))
# 
# 
# d
# e

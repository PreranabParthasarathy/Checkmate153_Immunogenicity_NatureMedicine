...
```{r echo=FALSE}
clincalData<-readRDS(file = "/Volumes/chant2lab/wrkg/projects/active/BMS153/Analysis_Dec_2022/CDKN2A/ClinicalData.rds")
...
ssgsea_scores<-read.csv("/Volumes/chant2lab/wrkg/projects/active/BMS153/Analysis_Dec_2022/Stats_on_Immune/ssGSEA_Scores.csv", row.names = 1)
...
Metadatav2<-read.csv("/Volumes/chant2lab/wrkg/projects/active/BMS153/Figures_dev/RNAseqAnalysis/BMS038vsBMS153comp/BMS153_analysis_12_1_21/BMS153/Metadata_bms153.csv")
...
c5_bp<-read.gmt("/Volumes/chant2lab/CITI_Bioinformatics/GENESETS_SS/Human/MSIGDB/MSIGDB_c5.go.bp.v2023.2.Hs.symbols.gmt")
c5_bp_sub<-c5_bp[which(str_detect(c5_bp$term,"MUSCLE",negate=TRUE)),]

diff_All<-read.csv("/Volumes/chant2lab/wrkg/projects/active/BMS153/Figures_dev/RNAseqAnalysis/BMS038vsBMS153comp/BMS153_analysis_12_1_21/BMS153_v2_2024_PP/DifferentialExpression_pairedTime_on_vs_pre.csv")
diff_NR<-read.csv("/Volumes/chant2lab/wrkg/projects/active/BMS153/Figures_dev/RNAseqAnalysis/BMS038vsBMS153comp/BMS153_analysis_12_1_21/BMS153_v2_2024_PP/DifferentialExpression_pairedTime_Response_on_PD_vs_pre_PD.csv")
diff_R<-read.csv("/Volumes/chant2lab/wrkg/projects/active/BMS153/Figures_dev/RNAseqAnalysis/BMS038vsBMS153comp/BMS153_analysis_12_1_21/BMS153_v2_2024_PP/DifferentialExpression_pairedTime_Response_on_PRSD_vs_pre_PRSD.csv")
...
# out_dir<-"/Volumes/chant2lab/wrkg/projects/active/BMS153/Figures_dev/RNAseqAnalysis/BMS038vsBMS153comp/BMS153_analysis_12_1_21/BMS153_v2_2024_PP/output/"
